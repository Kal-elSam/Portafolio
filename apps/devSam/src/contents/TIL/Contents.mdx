...
<TIL.Items date="2024-02-03">
  <TIL.Item>
    ...
    <TIL.ItemTags>
      ...
      <TIL.ItemTag>Database</TIL.ItemTag>
    </TIL.ItemTags>
    Master SQL fundamentals with PostgreSQL. Learn installation, querying, data manipulation, permissions, and backups for efficient database management.
  </TIL.Item>
</TIL.Items>
