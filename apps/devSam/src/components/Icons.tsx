...
export function HackerIcon(props: ComponentProps<'svg'>) {
  return (
    <svg 
    xmlns="http://www.w3.org/2000/svg" 
    role="img"
...
export function LinkedInIcon(props: ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      <path d="M20.546 20.547h-3.468v-5.422c0-1.297-.026-2.966-1.8-2.966-1.801 0-2.076 1.407-2.076 2.863v5.525H9.288V8.782h3.349v1.523h.047c.467-.887 1.611-1.824 3.305-1.824 3.527 0 4.17 2.323 4.17 5.35v6.816zM5.008 7.259a2.257 2.257 0 11-.046-4.513 2.257 2.257 0 01.046 4.513zm1.735 13.288H3.274V8.782h3.469v11.765zM22.022.007H1.975C.881.007 0 .887 0 1.982v20.036C0 23.113.881 24 1.975 24h20.047c1.094 0 1.978-.887 1.978-1.982V1.982C24 .888 23.116.007 22.022.007z" />
    </svg>
  );
}
...
export function FlutterIcon(props: ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      <path d="M18.909 14.84l-8.086 8.070 8.085 8.085h9.214l-8.073-8.083 8.073-8.073h-9.212zM18.892 1.004l-15.013 14.996 4.624 4.624 19.599-19.603h-9.194z" />
    </svg>
  );
}
